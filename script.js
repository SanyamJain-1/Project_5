document.getElementById("tempratureConverter").onclick = function(){
    ...
    if(document.getElementById("toFahrenite").checked){
        document.getElementById("message").innerHTML = `Temprature in Fahrenite is :: ${temp*9/5 + 32} °F`;
    }
    else if(document.getElementById("toCelsius")){
        document.getElementById("message").innerHTML = `Temprature in Celsius is :: ${(temp-32)*5/9} °C`;
    }
    else{{
